...
Use the "make parser" command to build and then "bin/parser" to run it. 

The application will convert MIPS assembly code into machine binary. In case of an error, i.e. entering the wrong number of operands for a given instruction, the program will tell you the instruction at fault.   
